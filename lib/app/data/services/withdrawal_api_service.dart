...
class WithdrawalApiService {
  ...
  static const String _getWithdrawalRecordsEndpoint =
      'app/withdrawRecord/getPage';
  static const String _withdrawalEndpoint = 'app/goldenFlowInfo/withdrawal';
  static const String _getWithdrawalSettingEndpoint =
      'app/goldenFlowInfo/getWithdrawalSetting';
  ...
  Future<BaseListEntity<WithdrawalRecord>> getWithdrawalRecords({
    ...
    try {
      final queryParameters = <String, dynamic>{'current': page, 'size': limit};
